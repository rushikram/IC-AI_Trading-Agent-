...
import { idlFactory } from './defai_backend.did.js';
export { idlFactory } from './defai_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_DEFAI_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./defai_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the defai_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./defai_backend.did.js")._SERVICE>}
 */
export const defai_backend = createActor(canisterId);
